...
type UserStore interface {
	...
	GetByFilter(context.Context, map[string]any) (*types.User, error) // ???
...
func (s *MongoUserStore) GetByFilter(ctx context.Context, filters map[string]any) (*types.User, error) {
	var user types.User
